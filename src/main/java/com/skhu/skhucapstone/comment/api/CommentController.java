...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<CommentResponse>> createComment(
        ...
        return ResponseEntity.ok(ApiResponse.success(SuccessCode.COMMENT_CREATE_SUCCESS, response));
    }

    @DeleteMapping("/comments/{commentId}")
    public ResponseEntity<ApiResponse<Void>> deleteComment(@PathVariable Long commentId, @AuthenticationPrincipal Long userId) {
    ...
    public ResponseEntity<ApiResponse<List<CommentResponse>>> getComments(@PathVariable Long postId) {
        ...
        return ResponseEntity.ok(ApiResponse.success(SuccessCode.COMMENT_LIST_GET_SUCCESS, response));
    }
}